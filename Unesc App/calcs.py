def calc_square ():
    alt_square = float (input("Digite a altura do seu quadrado: "))
    area_square = alt_square * alt_square
    print(f"A área de seu quadrado é: {area_square}.")

def calc_circle ():
    ray_circle = float (input("Digite o raio do seu círculo: "))
...
def calc_cilinder ():
    ray_cilinder = float (input("Digite o raio do seu cilindro: "))
    alt_cilinder = float (input("Digite a altura do seu cilindro: "))
